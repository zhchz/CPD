...
class KrylovSchurGEigsSolver<OpType, BOpType, GEigsMode::Cholesky> :
    public KrylovSchurEigsBase<SymGEigsCholeskyOp<OpType, BOpType>, IdentityBOp>
{
private:
    ...
    using Base = KrylovSchurEigsBase<ModeMatOp, IdentityBOp>;
...
class KrylovSchurGEigsSolver<OpType, BOpType, GEigsMode::RegularInverse> :
    public KrylovSchurEigsBase<SymGEigsRegInvOp<OpType, BOpType>, BOpType>
{
private:
    using Index = Eigen::Index;

    using ModeMatOp = SymGEigsRegInvOp<OpType, BOpType>;
    using Base = KrylovSchurEigsBase<ModeMatOp, BOpType>;
